...
use super::stringifier::{stringify_calc, ShouldPrintCalc};
use super::super::parser::parse as calc_parse;
...
pub fn transform_selector(
    ...
    use crate::vendor::postcss_selector_parser::nodes::{walk_all, NodeKind};
    use crate::vendor::postcss_selector_parser::Processor;
    ...
    let result = Processor::new().process(value, |root| {
        ...
        let mut visit = |parent: &mut crate::vendor::postcss_selector_parser::nodes::Node, idx: usize| {
...
mod tests {
    use super::*;
    use super::super::convert_unit::Precision;
