...
describe('babel plugin', () => {
  ...
  it('should not comment file if no transformation occurred', () => {
    const actual = transform(`
      import { ClassNames } from '@sjcompiled/react/runtime';
    `);
  ...
  it('should generate fallback file comment when filename is not defined', () => {
    ...
    expect(actual).toInclude('File generated by @sjcompiled/babel-plugin v0.0.0');
  });
  ...
  it('should generate fallback file comment when filename is defined', () => {
    ...
    expect(actual).toInclude('test.tsx generated by @sjcompiled/babel-plugin v0.0.0');
  });
  ...
  it('should transform basic styled component', () => {
    ...
    expect(actual).toMatchInlineSnapshot(`
      "/* File generated by @sjcompiled/babel-plugin v0.0.0 */
  ...
  it('should not remove manual runtime import if no transformation occurs', () => {
    const actual = transform(`
      import { CC } from '@sjcompiled/react/runtime';
  ...
  it('should append to manual runtime import if already present and transformation occurs', () => {
    const actual = transform(`
      import { CC as CompiledRoot, ax } from '@sjcompiled/react/runtime';
      import '@sjcompiled/react';
    ...
    expect(actual).toMatchInlineSnapshot(`
      "/* File generated by @sjcompiled/babel-plugin v0.0.0 */
      import * as React from "react";
      import { CC as CompiledRoot, ax, ix, CC, CS } from "@sjcompiled/react/runtime";
  ...
  it('should import ac if compression map is provided', () => {
    ...
    expect(actual).toInclude('import { ac, ix, CC, CS } from "@sjcompiled/react/runtime"');
  });
});
