...
const Comp = forwardRef(({
  ...
  return <CC>
        <CS>{[_, _2]}</CS>
        <C {...__cmpldp} style={__cmpls} ref={__cmplr} className={ax(["", __cmplp.isFlexible && !__cmplp.isSwimlaneMode && (fg('avoid_board_scroll_container_style_changes') ? "_1tke1osq" : "_1tkei63v"), __cmplp.className])} />
      </CC>;
});
