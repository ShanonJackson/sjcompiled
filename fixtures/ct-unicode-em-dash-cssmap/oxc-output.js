...
const styles = { tag: "_ca0q1y44 _u5f3ftgi _n3td1y44 _19bvftgi _2rko1l7b _19it14it _1e0c1o8l _1wyb1crf _k48p8n31 _1p1dangw" };
export function TagComponent({ children, color }) {
  ...
  {<Tag color={color} className={ax([styles.tag])}>
			{children}
		</Tag>}
  </CC>;
}
