...
const styles = { root: "_1e0c11p5 _1tke1kxc _1lmcq9em _yv0ei47z _2z0516ab _1ciragmp _12fkuz0r _12qzrxre _1rqt70if" };
export function Root({ children, xcss, testId }) {
  ...
  {<div data-testid={testId} className={ax([styles.root, xcss])}>
			{children}
		</div>}
  </CC>;
}
