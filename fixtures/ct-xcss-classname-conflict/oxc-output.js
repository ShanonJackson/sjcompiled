...
const mainElementStyles = { root: "_nd5l1gzg _1reo1wug _18m91wug _19121cl4 _152tckbl _qwfh1wug _165tk7wh _13wn1if8" };
export function Main({ children, xcss, testId }) {
  ...
  {<div role="main" data-testid={testId} className={ax([mainElementStyles.root, xcss])}>
				{children}
			</div>}
  </CC>
		</Fragment>;
