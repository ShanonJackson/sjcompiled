...
const _41 = "._syazwwip{color:#292a2e}";
const _40 = "._syazvwuj{color:#42526e}";
const _39 = "._12jin0nx{outline-color:#94c748}";
const _38 = "._12jia2c0{outline-color:#f87168}";
const _37 = "._12ji157s{outline-color:#c97cf4}";
const _36 = "._12jih727{outline-color:#fca700}";
const _35 = "._12jiuisw{outline-color:#669df1}";
const _34 = "._12y3t94y{outline-width:1px}";
const _33 = "._1qu2nqa1{outline-style:solid}";
const _32 = "._12ji14je{outline-color:#b7b9be}";
const _31 = "._19it1am1{border:1px solid #94c748}";
const _30 = "._19itoa5t{border:1px solid #f87168}";
const _29 = "._19it1apr{border:1px solid #c97cf4}";
const _28 = "._19itzi1n{border:1px solid #fca700}";
const _27 = "._19it1cy7{border:1px solid #669df1}";
const _26 = "._19it14mp{border:1px solid #b7b9be}";
const _25 = "._bfhk1hxd{background-color:#f4f5f7}";
const _24 = "._bfhk3uhp{background-color:#b3df72}";
const _23 = "._bfhk1366{background-color:#fd9891}";
const _22 = "._bfhkshej{background-color:#d8a0f7}";
const _21 = "._bfhkxmjf{background-color:#f9c84e}";
const _20 = "._bfhk1ymo{background-color:#8fb8f6}";
const _19 = "._bfhk1fkg{background-color:#dddee1}";
...
const _14 = "._k48p8n31{font-weight:bold}";
const _13 = "._zg8l4jg8{font-style:normal}";
const _12 = "._1wyb1skh{font-size:11px}";
const _11 = "._ect49sn6{font-family:ui-sans-serif}";
const _10 = "._1cwg1n1a{outline-offset:-1px}";
const _9 = "._y4ti1y44{padding-inline-end:4px}";
const _8 = "._bozg1y44{padding-inline-start:4px}";
const _7 = "._1kz6184x{block-size:-moz-min-content;block-size:min-content}";
