...
const PaddingWrapper = forwardRef(({
  as: C = "div",
  style: __cmpls,
  ...__cmplp
}, __cmplr) => {
  ...
  return <CC>
        <CS>{[_, _2, _3, _4, _5]}</CS>
        <C {...__cmpldp} style={__cmpls} ref={__cmplr} className={ax(["", __cmplp.isSummaryView ? "_ca0q1y44 _u5f3ftgi _n3tdftgi _19bvidpf" : "_ca0q1y44 _u5f3ftgi _n3tdftgi _19bv1crf", __cmplp.className])} />
      </CC>;
});
