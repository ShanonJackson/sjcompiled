...
const _11 = "@media not all and (min-width:110.5rem){._14wz19ly{display:revert}}";
const _10 = "@media not all and (min-width:90rem){._liwc19ly{display:revert}}";
...
export const Show = ({ above, below, children, as: AsElement = "div", className }) => {
  ...
  {<AsElement className={ax([styles.default, className])}>
			{children}
		</AsElement>}
  </CC>;
};
