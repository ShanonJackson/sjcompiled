...
export default function Component({
  ...
  const customCss = [customSpacingStyles, isEmbedView !== true && isModalView !== true ? fullpageStyles : null, isModalView === true ? modalStyles : null];
  return <CC>
  <CS>{[_, _2, _3]}</CS>
  {<div className={ax(["_p12f107j", isEmbedView !== true && isModalView !== true && "_uwhkftgi", isModalView === true && "_19pk10j7"])}>hello</div>}
  </CC>;
}