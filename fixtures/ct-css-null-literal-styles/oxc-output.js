...
const _13 = "._1i4qfg65{overflow-wrap:anywhere}";
const _12 = "._c71l53f4{max-height:75pt}";
const _11 = "._18m91wug{overflow-y:auto}";
const _10 = "._1reo1wug{overflow-x:auto}";
...
const Flag = ({ description, testId }) => {
	return <CC>
  <CS>{[_]}</CS>
  {<div role="alert" data-testid={testId} className={ax(["_1bsb1osq"])}>
			<CC>
  <CS>{[
		_2,
		_3,
  ...
  {<div className={ax(["_1e0c1txw _1ul91tcg _1tke1tcg _4cvr1h6o _1bah1h6o _1o9zidpf _syaz1jn0"])}>
				Icon
			</div>}
  </CC>
			<CC>
  ...
  {<div className={ax(["_11c81lyf _1reo1wug _18m91wug _c71l53f4 _1i4qfg65"])}>
				{description}
			</div>}
  </CC>
		</div>}
