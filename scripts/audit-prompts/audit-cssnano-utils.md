# Re-audit: `cssnano-utils@3.1.0` (no drift)
...
## Specific to `cssnano-utils`

`cssnano-utils@3.1.0` is **NOT** drifted between the
...
Shared helpers used by ~every cssnano plugin we run. A bug here propagates everywhere.

## Source locations

- **AFM-pinned source (3.1.0)**: `node_modules/.bun/cssnano-utils@3.1.0/node_modules/cssnano-utils/`
- **Rust port**: `crates/cssnano-utils/`
...
Walk every file in `node_modules/.bun/cssnano-utils@3.1.0/node_modules/cssnano-utils/src/`.
...
Write a concise audit document at `crates/_vendor/CSSNANO_UTILS_3.1.0_REAUDIT.md` containing:
