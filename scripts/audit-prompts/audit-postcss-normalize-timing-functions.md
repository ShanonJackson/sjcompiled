...
## Specific to `postcss-normalize-timing-functions`

`postcss-normalize-timing-functions@5.1.0` is **NOT** drifted between the
...
Compresses `cubic-bezier(...)` / `steps(...)` to keyword equivalents (ease/linear/etc), strips redundant trailing `, end` from `steps(N, end)`. No options.

## Source locations

- **AFM-pinned source (5.1.0)**: `node_modules/.bun/postcss-normalize-timing-functions@5.1.0/node_modules/postcss-normalize-timing-functions/`
- **Rust port**: `crates/cssnano-postcss-normalize-timing-functions/`
...
Walk every file in `node_modules/.bun/postcss-normalize-timing-functions@5.1.0/node_modules/postcss-normalize-timing-functions/src/`.
...
crates/target/debug/parity-runner --stage postcss-normalize-timing-functions --corpus crates/parity-runner/corpus/postcss-normalize-timing-functions --determinism
```
...
Write a concise audit document at `crates/_vendor/POSTCSS_NORMALIZE_TIMING_FUNCTIONS_5.1.0_REAUDIT.md` containing:
